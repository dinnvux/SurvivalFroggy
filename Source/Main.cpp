...
#include "../Source/Headers/Car.hpp"
#include "../Source/Headers/Frog.hpp"
#include "../Source/Headers/CarsManager.hpp"
#include "../Source/Headers/DrawMap.hpp"
#include "../Source/Headers/DrawText.hpp"
#include "../Source/Headers/Global.hpp"
#include "../Source/Headers/Log.hpp"
#include "../Source/Headers/Turtle.hpp"
#include "../Source/Headers/RiverManager.hpp"
...
int main()
{
	...
	sf::RenderWindow window(sf::VideoMode(CELL_SIZE * MAP_WIDTH * SCREEN_RESIZE, SCREEN_RESIZE * (FONT_HEIGHT + CELL_SIZE * MAP_HEIGHT)), "Suvival Froggy", sf::Style::Close);
